                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-12">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay="0.2s">Platform<br> Belajar Online</h1>
                                <p data-animation="fadeInLeft" data-delay="0.4s">SMKS 9 Muhammadiyah Kota Bengkulu</p>
                                <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Mulai
                                    Sekarang</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section-tittle section-tittle2 mb-20">
                    <div class="front-text">
                        ...
                        <p>The automated process all your website tasks. Discover tools and techniques to engage effectively
                            with vulnerable children and young people.</p>
