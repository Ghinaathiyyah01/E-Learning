            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="/modul" class="nav-item nav-link"><i
                                    class="fas fa-book"></i><span>Modul</span></a></li>
                        <li><a href="/ujian" class="nav-item nav-link"><i
                                    class="fas fa-pencil-alt"></i><span>Ujian</span></a></li>
                        <li><a href="/nilai" class="nav-item nav-link"><i
                                    class="fas fa-chart-bar"></i><span>Nilai</span></a></li>
                    </ul>
                </aside>
            </div>
